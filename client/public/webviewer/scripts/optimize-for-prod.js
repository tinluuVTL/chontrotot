  ...
  prompt.get(schema, (err, result) => {
    ...
    if (webViewerServer === 'n' && xod === 'n') {
      ...
      if (useLeanPDF === 'n') {
        ...
        if (excludeOptimizedWorkers === 'n') {
          filesToRelocate.push(
            [path.resolve(__dirname, `../${wvFolder}/core/pdf/lean/optimized/PDFNetCWasm.br.js.mem`), `${resourceDir}/pdf_lean/lean/optimize`],
            [path.resolve(__dirname, `../${wvFolder}/core/pdf/lean/optimized/PDFNetCWasm.br.wasm`), `${resourceDir}/pdf_lean/lean/optimize`],
